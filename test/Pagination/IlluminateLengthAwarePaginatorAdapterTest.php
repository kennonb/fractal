...
use League\Fractal\Pagination\IlluminateLengthAwarePaginatorAdapter;
use Mockery;

class IlluminateLengthAwarePaginatorAdapterTest extends \PHPUnit_Framework_TestCase
{
    public function testPaginationAdapter()
    {
        ...
        $adapter = new IlluminateLengthAwarePaginatorAdapter($paginator);
